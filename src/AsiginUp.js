...
function AsigninUp() {
  ...
  const handleRegister = (e) => {
      e.preventDefault();
      axios.post("http://localhost:8081/adminregister",{
        email:email,
        user:username,
        password:password,
      }).then((response) => {
        ...
        <MDBCardBody>
          <MDBRow>
            <MDBCol md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
              ...
              <p classNAme="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Register As Administrator</p>
